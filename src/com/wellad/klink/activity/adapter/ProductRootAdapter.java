 ...
 * @author Roy Wang
 */
public class ProductRootAdapter extends ArrayListAdapter<ProductCategoryBean> {

	public ProductRootAdapter(Activity context) {
		super(context);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final ProductCategoryBean bean = this.mList.get(position);
		if (convertView == null) {

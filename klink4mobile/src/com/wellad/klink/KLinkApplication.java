/*
 * @(#)KLinkApplication.java 2014年1月31日
 * 
...
public class KLinkApplication extends Application {
	...
	private Activity uiactivty;

	public Activity getUiactivty() {
		return uiactivty;
	}

	public void setUiactivty(Activity uiactivty) {
		this.uiactivty = uiactivty;
	}
	...
	public static KLinkApplication getInstance() {
		return instance;
	}

	// ====================================================
	// GLOBE ARRAYLIST 4 MODEL
	// ====================================================
	private ArrayList<SearchResult> srList = new ArrayList<SearchResult>();

	public ArrayList<SearchResult> getSrList() {
		return srList;
	}

	public void setSrList(ArrayList<SearchResult> srList) {
		this.srList = srList;
	}
	...
	public void initGPS() {
		...
		if (Config.items2 != null) {
			// AroundMeShop sh0 = new
			// AroundMeShop("ShangHai","SH001","121.223933","31.1326347");

			AroundMeShop sh1 = new AroundMeShop("MASAI", "SJH113", "1.485903",
					"103.886115", "Yap Siow Yen");
			AroundMeShop sh2 = new AroundMeShop("BATU PAHAT", "SJH116",
					"1.863859", "102.939337", "Mohd Zakaria Bin Salim");
			AroundMeShop sh3 = new AroundMeShop("YONG PENG", "SJH70",
					"2.015822", "103.065624", "Spring Sunflower Trading");
			AroundMeShop sh4 = new AroundMeShop("SKUDAI", "SJH91", "1.542263",
					"103.63154", "Valiant Link Sdn. Bhd");

			//
			AroundMeShop sh5 = new AroundMeShop("ALOR SETAR", "SKD131",
					"6.081163", "100.36172", "Khong Woei Seong");
			//
			AroundMeShop sh6 = new AroundMeShop("KOTA BHARU", "SKT104",
					"6.164460", "102.281183", "DR. Mohd Razali Bin Aziz");
			AroundMeShop sh7 = new AroundMeShop("KOTA BHARU", "SKT107",
					"5.913929", "102.244745", "Mohamad Bin Ibrahim");
			//
			AroundMeShop sh8 = new AroundMeShop("Fraser Business Park",
					"SWP60", "3.128454", "101.713638",
					"K-System Global Sdn Bhd");
			AroundMeShop sh9 = new AroundMeShop("Setapak", "SWP99", "3.206938",
					"101.719172", "Raihan Binti Haji Wan Ibrahim");
			//
			AroundMeShop sh10 = new AroundMeShop("LABUAN", "SLB93", "5.279987",
					"115.23972",
					"Chieng Hock Ting KEDAI UNION TRADING (DUTY FREE SHOP)");
			//
			AroundMeShop sh11 = new AroundMeShop("Bandar Malacca", "SML95",
					"2.228027", "102.225712", "Rose Pua");
			//
			AroundMeShop sh12 = new AroundMeShop("Senawang", "SNS121",
					"2.693721", "102.000264", "Mohamad Ma'Arof Bin Ariffin");
			AroundMeShop sh13 = new AroundMeShop("Nilai", "SNS129", "2.801202",
					"101.806997", "Erik A/L Michael");
			AroundMeShop sh133 = new AroundMeShop("KUANTAN", "SNS133",
					"3.828806", "103.302018",
					"Datin Sri Hjh Juriah Binti Hassan");
			AroundMeShop sh134 = new AroundMeShop("RAUB", "SNS134", "3.797108",
					"101.861672", "V Sithambaram A/L Velusamy");
			AroundMeShop sh135 = new AroundMeShop("JENGKA", "SNS135",
					"3.770497", "102.547633", "Zainal Abidin Bin Zakaria");

			//
			// AroundMeShop sh14 = new
			// AroundMeShop("Pahang","SPH86","3.828806","103.302018","");
			// AroundMeShop sh15 = new
			// AroundMeShop("Pahang","SPH124","3.797108","101.861672","");
			// AroundMeShop sh16 = new
			// AroundMeShop("Pahang","SPH135","3.770497","102.547633","");
			//
			AroundMeShop sh17 = new AroundMeShop("PENANG", "SPN026",
					"5.425979", "100.318152",
					"Lighthouse Lighting & Interior Sdn.Bhd");
			AroundMeShop sh18 = new AroundMeShop("BUTTERWORTH", "SPN115",
					"5.441743", "100.386575", "Wan Giap Poh");
			AroundMeShop sh19 = new AroundMeShop("NIBONG TEBAL", "SPN118",
					"5.195161", "100.492313", "Tamil Selvi A/P Arumugam");
			AroundMeShop sh20 = new AroundMeShop("BAYAN LEPAS", "SPN136",
					"5.33185", "100.293012", "Abd Hamid Bin Abd Aziz");
			//
			AroundMeShop sh21 = new AroundMeShop("IPOH", "SPR03", "4.615951",
					"101.119583", "Eric Wong Wai Keong");
			AroundMeShop sh22 = new AroundMeShop("TELUK INTAN", "SPR92",
					"4.005801", "101.0218", "Ooi Hock Tai");
			AroundMeShop sh23 = new AroundMeShop("Sitiawan", "SPR94",
					"4.208291", "100.655332", "Sri Harti");
			//
			AroundMeShop sh24 = new AroundMeShop("TAWAU", "SSB109", "4.242489",
					"117.887447", "Andi Nurerfarina Famizah Bt ADjafar");
			AroundMeShop sh25 = new AroundMeShop("LAHAD DATU", "SSB122",
					"5.027132", "118.298548", "Bahri Bin Silang");
			AroundMeShop sh26 = new AroundMeShop("KENINGAU", "SSB123",
					"5.265303", "116.328209", "Dalley Binti Jaimi");
			AroundMeShop sh27 = new AroundMeShop("KOTA KINABALU", "SSB128",
					"5.947768", "116.089589", "Naimah Binti Ilyas");
			AroundMeShop sh28 = new AroundMeShop("SANDAKAN", "SSB133",
					"5.84847", "118.05555", "Usman Bin Ruslan");
			//
			AroundMeShop sh29 = new AroundMeShop("KUCHING", "SSR07",
					"1.553082", "110.363955", "K-Link Kuching Stockist");
			AroundMeShop sh30 = new AroundMeShop("MIRI", "SSR15", "4.413733",
					"114.006108", "Kino-Link Sdn Bhd");
			AroundMeShop sh31 = new AroundMeShop("SIBU", "SSR134", "2.291886",
					"111.835101", "Law Ngieh Hui");
			//
			AroundMeShop sh32 = new AroundMeShop("Kajang", "SSL102",
					"2.992011", "101.799761", "Nazaruddin Bin Zakaria");
			AroundMeShop sh33 = new AroundMeShop("Sungai Buloh", "SSL105",
					"3.210379", "101.562327", "Mejer Lias Bin Mohd");
			AroundMeShop sh34 = new AroundMeShop("Banting", "SSL110",
					"2.84713", "101.519346", "Ibrahim Bin Osman");
			AroundMeShop sh35 = new AroundMeShop("Ampang", "SSL111",
					"3.135259", "101.769887", "Yap Swee Meng");
			AroundMeShop sh36 = new AroundMeShop("Kuala Selangor", "SSL117",
					"3.320913", "101.271178", "Joshua Yap Wei Lieh");
			AroundMeShop sh37 = new AroundMeShop("Rawang", "SSL120",
					"3.319612", "101.57695", "Asmah Binti Atan");
			AroundMeShop sh38 = new AroundMeShop("Klang", "SSL74", "3.010115",
					"101.43979", "Irene Chen Yoke Moi");
			AroundMeShop sh39 = new AroundMeShop("Petaling Jaya", "SSL125",
					"3.086731", "101.623411", "Chuah Chin Koon");
			AroundMeShop sh40 = new AroundMeShop("Shah Alam", "SSL126",
					"3.031412", "101.534952", "Peter Rayan A/L Gnanapragasam");
			AroundMeShop sh41 = new AroundMeShop("Puchong", "SSL132",
					"2.982591", "101.610904", "Siti Sara Binti Mat Jusoh");

			//
			AroundMeShop sh42 = new AroundMeShop("Marang", "STR112",
					"5.166173", "103.232167", "Zulkefli Bin Mohamed");
			AroundMeShop sh43 = new AroundMeShop("Kuala Terengganu", "STR130",
					"5.314613", "103.119971", "Rohani Binti Harun");
	...
	// The name of the shared preferences used by this application.
	public static final String SHARED_PREFS_MAIN = "KLinkSettings";
	public static final String SHARED_PREFS_ACCOUNT_USERNAME = "account.username";
	public static final String SHARED_PREFS_ACCOUNT_PASSWORD = "account.password";
	public static final String SHARED_PREFS_ACCOUNT_NAME = "account.name";
	public static final String SHARED_PREFS_ACCOUNT_EMAIL = "account.email";
	public static final String SHARED_PREFS_ACCOUNT_DATEOFBIRTH = "account.dateofbirth";
	public static final String SHARED_PREFS_ACCOUNT_GENDER = "account.gender";
	public static final String SHARED_PREFS_ACCOUNT_ADDRESS = "account.address";
	public static final String SHARED_PREFS_KLINK_MEMBERCODE = "k-link.membercode";
	...
	public static int writeIntToSharedPreferences(final String pStr, final int pValue) {
		getInstance().getSharedPreferences(SHARED_PREFS_MAIN, 0).edit().putInt(pStr, pValue).apply();
		return pValue;
	}

	public static int getIntFromSharedPreferences(final String pStr) {
		return getInstance().getSharedPreferences(SHARED_PREFS_MAIN, 0).getInt(pStr, 0);
	}
	
	// Methods to write/read Integers in the Shared Preferences.
	public static String writeStringToSharedPreferences(final String pStr, final String pValue) {
		getInstance().getSharedPreferences(SHARED_PREFS_MAIN, 0).edit().putString(pStr, pValue).apply();
		return pValue;
	}

	public static String getStringFromSharedPreferences(final String pStr) {
		return getInstance().getSharedPreferences(SHARED_PREFS_MAIN, 0).getString(pStr, null);
	}
	...
	public static void writeBooleanToSharedPreferences(final String pStr, final boolean pValue) {
		getInstance().getSharedPreferences(SHARED_PREFS_MAIN, 0).edit().putBoolean(pStr, pValue).apply();
	}

	public static boolean getBooleanFromSharedPreferences(final String pStr) {
		return getInstance().getSharedPreferences(SHARED_PREFS_MAIN, 0).getBoolean(pStr, false);
	}

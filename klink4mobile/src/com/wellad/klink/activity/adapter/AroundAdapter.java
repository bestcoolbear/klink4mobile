 ...
 * @author Roy Wang
 */
public class AroundAdapter extends ArrayListAdapter<AroundMeLocation> {

	public AroundAdapter(Activity context) {
		super(context);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final AroundMeLocation al = this.mList.get(position);
		if (convertView == null) {
		...
		holder.textView.setText(al.getLocationame());
